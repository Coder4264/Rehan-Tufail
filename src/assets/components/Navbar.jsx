...
export default function Navbar() {
  ...
  return (
    <div>
    <div className='sticky top-0 z-10 md:w-11/12 md:flex hidden md:my-10 m-3 md:m-auto bg-black rounded-2xl flex justify-between items-center p-3 '>
        <div className="logo">
        ...
        {/* Link for the "Let's Talk" button */}
        <Link to="/ConnectForm" className="message flex justify-between items-center gap-3 cursor-pointer duration-500 hover:bg-blue-600 hover:text-white active:bg-blue-800 ">
            <span className='text-md text-slate-300 font-semibold'>Let's Talk</span>
            <img src="https://cdn-icons-png.flaticon.com/128/9847/9847407.png" className='icons' alt="Let's Talk Icon" />
        </Link>
    </div>
    <Outlet/>
    </div>
